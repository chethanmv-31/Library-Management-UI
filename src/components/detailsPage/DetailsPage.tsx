      ...
      <div className="flex justify-between">
        <div className="flex gap-[70px]">
          ...
          <div className="w-[505px]">
            <p className="text-[35px] text-[#4D4D4D] pb-[38px]">{book.title}</p>
        ...
        <div className="w-[450px] h-[420px] bg-white rounded-xl p-[30px]">
          ...
          <p className="text-[13px] my-1">
            {book.author.author_Name} is the author of this book. More details
            about the author will be available soon.
          </p>
          ...
          <div className="flex space-x-8 my-1">
            {[1, 2, 3].map((item) => (
              <div
                key={item}
                className="w-[77px] h-[100px] border border-[#F1F1F1] rounded-md"
              >
                <Image
